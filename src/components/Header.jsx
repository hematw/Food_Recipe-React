...
export default function Header({ sendData }) {
  ...
  return (
    <>
      <header className="px-8 py-4 sm:px-14  border-b border-gray-700 flex-wrap ">
        <div className="flex justify-center md:justify-start items-center max-w-7xl mx-auto">
          <img
            className="w-14 md:w-16 bg-white rounded-full"
            src="/atom_food.png"
            alt="Atom Food Logo."
          />
          ...
          <div className="m-auto sm:ml-auto mt-6 sm:m-0 bg-sky-950 w-full sm:w-fit">
            ...
            >
              ...
              />
              <button className="px-2 ml-auto border border-sky-700">
                <svg
